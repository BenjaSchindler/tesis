...
\toprule
\textbf{Temperatura ($\tau$)} & \textbf{N Sintéticos} & \textbf{Calidad} & \textbf{Macro F1} & \textbf{$\Delta$ F1 (pp)} & \textbf{p-valor} \\
\midrule
\rowcolor{green!20}
\textbf{0.3} & \textbf{125} & \textbf{0.245} & \textbf{0.2063} & \textbf{+0.18} & \textbf{0.027} \\
0.5 & 125 & 0.238 & 0.2057 & +0.12 & 0.091 \\
0.7 & 125 & 0.231 & 0.2056 & +0.11 & 0.081 \\
0.9 & 125 & 0.219 & 0.2051 & +0.06 & 0.345 \\
\bottomrule
\end{tabular}
