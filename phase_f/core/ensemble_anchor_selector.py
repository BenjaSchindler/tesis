...
class EnsembleAnchorSelector:
    ...
    def __init__(
        ...
        use_hard_anchors: bool = True  # Phase A improvement: hard anchors strategy
    ):
        """
        ...
        Args:
            ...
            use_hard_anchors: Enable 4th strategy (hard anchors near decision boundary)
        """
        ...
        self.use_hard_anchors = use_hard_anchors
    ...
    def select_ensemble_anchors(
        ...
        # Strategy 4: Hard anchors (boundary points) - Phase A improvement, configurable
        hard_anchors = []
        if self.use_hard_anchors:
