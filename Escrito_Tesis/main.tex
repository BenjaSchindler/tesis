...
\thesistitle{Filtrado Geométrico de Muestras Sintéticas Generadas por Modelos de Lenguaje para la Clasificación de Texto en Escenarios de Recursos Limitados} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\thesistitleEnglish{Geometric Filtering of LLM-Generated Synthetic Samples for Text Classification in Low-Resource Scenarios} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitleEnglish
\supervisor{NOMBRE PROFESOR GUIA\\EN CASO DE CO-GUIA} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{NOMBRE DEL ESTUDIANTE} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
