...
\toprule
\textbf{Estrategia} & \textbf{Macro F1} & \textbf{Calidad} & \textbf{Diversidad} & \textbf{$\Delta$ F1 (pp)} & \textbf{p-valor} \\
\midrule
Aleatoria & 0.2062 & 0.17 & 0.64 & +0.17 & 0.088 \\
Vecino cercano & 0.2067 & 0.17 & 0.50 & +0.22 & 0.052 \\
\rowcolor{green!20}
\textbf{Medoide} & \textbf{0.2079} & \textbf{0.17} & \textbf{0.50} & \textbf{+0.34} & \textbf{0.005} \\
Quality-gated & 0.2044 & 0.06 & 0.03 & $-$0.01 & 0.891 \\
Diversa & 0.2065 & 0.14 & 0.90 & +0.20 & 0.063 \\
Ensemble & 0.2048 & 0.21 & 0.86 & +0.03 & 0.682 \\
\bottomrule
\end{tabular}
