...
\toprule
\textbf{Peso ($w$)} & \textbf{N Sintéticos} & \textbf{Calidad} & \textbf{Macro F1} & \textbf{$\Delta$ F1} & \textbf{p-valor} \\
\midrule
0.3 & 125 & 0.231 & 0.2103 & +2.83\% & $<$0.0001 \\
0.5 & 125 & 0.231 & 0.2081 & +1.76\% & 0.0009 \\
0.7 & 125 & 0.231 & 0.2100 & +2.68\% & $<$0.0001 \\
\rowcolor{green!20}
\textbf{1.0} & \textbf{125} & \textbf{0.231} & \textbf{0.2110} & \textbf{+3.17\%} & $<$\textbf{0.0001} \\
\bottomrule
\end{tabular}
