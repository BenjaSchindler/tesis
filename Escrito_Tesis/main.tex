...
% Forzar punto como separador decimal en modo matemático (estándar internacional para papers)
\AtBeginDocument{\spanishdecimal{.}}

% Permitir cortes de línea en guiones de identificadores en modo \texttt
\usepackage{hyphenat}
...
\supervisor{Dr. Gonzalo A. Ruz} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
\examiner{Dr. Luis Aburto\\Dr. Rolando De La Cruz\\Dr. Pablo Henríquez\\Dr. Andrés Peters} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
\degree{Master of Science in Data Science,\\ Ingeniería Civil Informática e\\ Ingeniería Civil Industrial} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\university{\href{https://www.uai.cl/}{Universidad Adolfo Ibáñez}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
...
\facultyEnglish{\href{https://ingenieria.uai.cl/}{Faculty of Engineering and Sciences}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
