...
\toprule
\textbf{Configuración} & \textbf{N Filtros} & \textbf{N Sintéticos} & \textbf{Calidad} & \textbf{Macro F1} & \textbf{$\Delta$ F1 (pp)} & \textbf{p-valor} \\
\midrule
Solo longitud & 1 & 127 & 0.154 & 0.2079 & +0.34 & 0.012 \\
Longitud + similaridad & 2 & 127 & 0.235 & 0.2074 & +0.29 & 0.040 \\
Tres filtros & 3 & 129 & 0.306 & 0.2074 & +0.29 & 0.002 \\
\rowcolor{green!20}
\textbf{Cascada completa} & \textbf{4} & \textbf{125} & \textbf{0.231} & \textbf{0.2081} & \textbf{+0.36} & \textbf{0.0009} \\
\bottomrule
\end{tabular}
